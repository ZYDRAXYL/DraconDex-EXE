...
contextBridge.exposeInMainWorld('api', {
  ...
  diviner: {
    ...
    createTable:   (mref,n,dc,md)  => inv('diviner:createTable', mref,n,dc,md),
    updateTable:   (id,n,dc,md)    => inv('diviner:updateTable', id,n,dc,md),
    deleteTable:   (id)            => inv('diviner:deleteTable', id),
    getEntries:    (tref)          => inv('diviner:getEntries', tref),
    createEntry:   (tref,tx,k)     => inv('diviner:createEntry', tref,tx,k),
    updateEntry:   (id,e)          => inv('diviner:updateEntry', id,e),
    deleteEntry:   (id)            => inv('diviner:deleteEntry', id),
    moveEntry:     (id,dir)        => inv('diviner:moveEntry', id,dir),
    roll:          (tref)          => inv('diviner:roll', tref),
    rollDice:      (expr)          => inv('diviner:rollDice', expr),
    getRolls:      (tref)          => inv('diviner:getRolls', tref),
    clearRolls:    (tref)          => inv('diviner:clearRolls', tref),
    wouldCycle:    (tref,target)   => inv('diviner:wouldCycle', tref,target),
  },
  trash: {
  ...
  classifier: {
    ...
    moveObject:        (id,mref)              => inv('classifier:moveObject', id,mref),
    ...
    createTemplate:    (mref,d,t,lv,c,oref,op) => inv('classifier:createTemplate', mref,d,t,lv,c,oref,op),
    updateTemplate:    (id,d,t,lv,c,op)       => inv('classifier:updateTemplate', id,d,t,lv,c,op),
  ...
  designer: {
    ...
    resizeNode: (id,w,h)            => inv('designer:resizeNode', id,w,h),
    setComic:   (id,k,ro)           => inv('designer:setComic', id,k,ro),
    renumber:   (mref,rtl)          => inv('designer:renumber', mref,rtl),
